...
public class WhereValues extends HashMap<TableColumn, Object> {
    ...
    public String toString() {
        ...
        for (TableColumn tableColumn : this.keySet()) {
            ...
            String whereTemplate = (value instanceof String) ? ("%1$s=\'%2$s\'") : ("%1$s=%2$s");
            if (tableColumn instanceof ForeignKey) {
                ...
                if (foreignKey instanceof AutoincrementColumn) {
                    ...
                    Map<String, TableColumn> fkColumns = foreignKey.getTable().getColumns();
                    ...
                    for (String columnName : fkColumns.keySet()) {
                        ...
                        whereSubrequesResult.append(String.format(
                                whereTemplate
